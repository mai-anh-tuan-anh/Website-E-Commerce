...
import { FaHome, FaPalette, FaMobileAlt, FaCode, FaRocket } from 'react-icons/fa';
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
                        Explore the building blocks that make our website beautiful and functional
                    </p>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
                        {[
                            ...
                            <div key={index} className="text-center">
                                <div className={`h-16 w-full ${color.color} rounded-lg mb-2 shadow-sm`}></div>
                ...
                <div className="bg-white rounded-xl p-8 shadow-md">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="text-3xl font-bold text-gray-900">Heading 2</div>
                        <div className="text-2xl font-semibold text-gray-900">Heading 3</div>
                        <div className="text-xl font-semibold text-gray-900">Heading 4</div>
                        <div className="text-lg text-gray-700">Large Body Text</div>
                        <div className="text-base text-gray-600">Regular Body Text</div>
                        <div className="text-sm text-gray-500">Small Text</div>
                        <div className="text-xs text-gray-400">Caption Text</div>
                    </div>
                </div>
            </div>
        </div>
